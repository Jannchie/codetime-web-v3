...
import type { V3GetRootData, V3GetRootResponses, V3GetTotalMinutesData, V3GetTotalMinutesResponses, V3CheckLoginData, V3CheckLoginResponses, V3GithubAuthData, V3GithubAuthResponses, V3GithubAuthErrors, V3GoogleAuthData, V3GoogleAuthResponses, V3GoogleAuthErrors, V3RefreshTokenData, V3RefreshTokenResponses, V3CountUserMinutesData, V3CountUserMinutesResponses, V3CountUserMinutesErrors, V3DeleteUserAccountData, V3DeleteUserAccountResponses, V3GetUserSelfData, V3GetUserSelfResponses, V3DeleteUserDataData, V3DeleteUserDataResponses, V3ExportUserDataData, V3ExportUserDataResponses, V3GetPrivacySettingsData, V3GetPrivacySettingsResponses, V3UpdatePrivacySettingsData, V3UpdatePrivacySettingsResponses, V3UpdatePrivacySettingsErrors, V3GetUserByUserIdData, V3GetUserByUserIdResponses, V3GetUserByUserIdErrors, V3GetUserShieldData, V3GetUserShieldResponses, V3GetUserShieldErrors, V3ListSelfLatestLogsData, V3ListSelfLatestLogsResponses, V3ListSelfLatestLogsErrors, V3ListSelfMinutesData, V3ListSelfMinutesResponses, V3ListSelfMinutesErrors, V3ListSelfStatsData, V3ListSelfStatsResponses, V3ListSelfStatsErrors, V3ListSelfStatsTimeData, V3ListSelfStatsTimeResponses, V3ListSelfStatsTimeErrors, V3ListSelfTopData, V3ListSelfTopResponses, V3ListSelfTopErrors, V3GetYearlyReportDataData, V3GetYearlyReportDataResponses, V3GetYearlyReportDataErrors, V3ListAggregatedLogData, V3ListAggregatedLogResponses, V3ListAggregatedLogErrors, V3ListRealtimeLogsData, V3ListRealtimeLogsResponses, V3ListRealtimeLogsErrors, V3ListTopLanguagesData, V3ListTopLanguagesResponses, V3ListTopLanguagesErrors, V3ListTopWorkspacesData, V3ListTopWorkspacesResponses, V3ListTopWorkspacesErrors, V3CreateCheckoutData, V3CreateCheckoutResponses, V3CreateCheckoutErrors, V3GetProductsData, V3GetProductsResponses, V3HandleLemonsqueezyWebhookData, V3HandleLemonsqueezyWebhookResponses, V3HandleLemonsqueezyWebhookErrors, V3GetLeaderboardData, V3GetLeaderboardResponses, V3GetLeaderboardErrors, V3SearchWorkspacesData, V3SearchWorkspacesResponses, V3SearchWorkspacesErrors, V3BeAnyUserData, V3BeAnyUserResponses, V3BeAnyUserErrors } from './types.gen';
import { client as _heyApiClient } from './client.gen';
import { v3CheckLoginResponseTransformer, v3GetUserSelfResponseTransformer, v3ExportUserDataResponseTransformer, v3GetUserByUserIdResponseTransformer, v3CreateCheckoutResponseTransformer, v3GetLeaderboardResponseTransformer, v3SearchWorkspacesResponseTransformer } from './transformers.gen';
 ...
 */
export const v3GithubAuth = <ThrowOnError extends boolean = false>(options: Options<V3GithubAuthData, ThrowOnError>) => {
...
export const v3SearchWorkspaces = <ThrowOnError extends boolean = false>(options?: Options<V3SearchWorkspacesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<V3SearchWorkspacesResponses, V3SearchWorkspacesErrors, ThrowOnError>({
        responseTransformer: v3SearchWorkspacesResponseTransformer,
