...
import type { V3BeAnyUserData, V3BeAnyUserErrors, V3BeAnyUserResponses, V3CheckLoginData, V3CheckLoginResponses, V3CountUserMinutesData, V3CountUserMinutesErrors, V3CountUserMinutesResponses, V3CreateCheckoutData, V3CreateCheckoutErrors, V3CreateCheckoutResponses, V3DeleteUserAccountData, V3DeleteUserAccountResponses, V3DeleteUserDataData, V3DeleteUserDataResponses, V3ExportUserDataData, V3ExportUserDataResponses, V3GetLeaderboardData, V3GetLeaderboardErrors, V3GetLeaderboardResponses, V3GetPrivacySettingsData, V3GetPrivacySettingsResponses, V3GetProductsData, V3GetProductsResponses, V3GetRootData, V3GetRootResponses, V3GetTotalMinutesData, V3GetTotalMinutesResponses, V3GetUserByUserIdData, V3GetUserByUserIdErrors, V3GetUserByUserIdResponses, V3GetUserSelfData, V3GetUserSelfResponses, V3GetUserShieldData, V3GetUserShieldErrors, V3GetUserShieldResponses, V3GetYearlyReportDataData, V3GetYearlyReportDataErrors, V3GetYearlyReportDataResponses, V3GithubAuthData, V3GithubAuthErrors, V3GithubAuthResponses, V3GoogleAuthData, V3GoogleAuthErrors, V3GoogleAuthResponses, V3HandleLemonsqueezyWebhookData, V3HandleLemonsqueezyWebhookErrors, V3HandleLemonsqueezyWebhookResponses, V3ListAggregatedLogData, V3ListAggregatedLogErrors, V3ListAggregatedLogResponses, V3ListRealtimeLogsData, V3ListRealtimeLogsErrors, V3ListRealtimeLogsResponses, V3ListSelfLatestLogsData, V3ListSelfLatestLogsErrors, V3ListSelfLatestLogsResponses, V3ListSelfMinutesData, V3ListSelfMinutesErrors, V3ListSelfMinutesResponses, V3ListSelfStatsData, V3ListSelfStatsErrors, V3ListSelfStatsResponses, V3ListSelfStatsTimeData, V3ListSelfStatsTimeErrors, V3ListSelfStatsTimeResponses, V3ListSelfTopData, V3ListSelfTopErrors, V3ListSelfTopResponses, V3ListTopLanguagesData, V3ListTopLanguagesErrors, V3ListTopLanguagesResponses, V3ListTopWorkspacesData, V3ListTopWorkspacesErrors, V3ListTopWorkspacesResponses, V3RefreshTokenData, V3RefreshTokenResponses, V3SearchWorkspacesData, V3SearchWorkspacesErrors, V3SearchWorkspacesResponses, V3UpdatePrivacySettingsData, V3UpdatePrivacySettingsErrors, V3UpdatePrivacySettingsResponses } from './types.gen'
 ...
 */
export function v3CheckLogin<ThrowOnError extends boolean = false>(options?: Options<V3CheckLoginData, ThrowOnError>) {
...
export function v3GithubAuth<ThrowOnError extends boolean = false>(options: Options<V3GithubAuthData, ThrowOnError>) {
  return (options.client ?? _heyApiClient).post<V3GithubAuthResponses, V3GithubAuthErrors, ThrowOnError>({
    url: '/v3/auth/github',
    ...options,
    headers: {
 ...
 */
export function v3RefreshToken<ThrowOnError extends boolean = false>(options?: Options<V3RefreshTokenData, ThrowOnError>) {
 ...
 */
export function v3DeleteUserAccount<ThrowOnError extends boolean = false>(options?: Options<V3DeleteUserAccountData, ThrowOnError>) {
 ...
 */
export function v3DeleteUserData<ThrowOnError extends boolean = false>(options?: Options<V3DeleteUserDataData, ThrowOnError>) {
 ...
 */
export function v3ExportUserData<ThrowOnError extends boolean = false>(options?: Options<V3ExportUserDataData, ThrowOnError>) {
 ...
 */
export function v3GetPrivacySettings<ThrowOnError extends boolean = false>(options?: Options<V3GetPrivacySettingsData, ThrowOnError>) {
 ...
 */
export function v3UpdatePrivacySettings<ThrowOnError extends boolean = false>(options: Options<V3UpdatePrivacySettingsData, ThrowOnError>) {
 ...
 */
export function v3ListSelfStats<ThrowOnError extends boolean = false>(options: Options<V3ListSelfStatsData, ThrowOnError>) {
 ...
 */
export function v3ListSelfStatsTime<ThrowOnError extends boolean = false>(options?: Options<V3ListSelfStatsTimeData, ThrowOnError>) {
 ...
 */
export function v3CreateCheckout<ThrowOnError extends boolean = false>(options: Options<V3CreateCheckoutData, ThrowOnError>) {
 ...
 */
export function v3GetProducts<ThrowOnError extends boolean = false>(options?: Options<V3GetProductsData, ThrowOnError>) {
 ...
 */
export function v3HandleLemonsqueezyWebhook<ThrowOnError extends boolean = false>(options: Options<V3HandleLemonsqueezyWebhookData, ThrowOnError>) {
 ...
 */
export function v3GetLeaderboard<ThrowOnError extends boolean = false>(options?: Options<V3GetLeaderboardData, ThrowOnError>) {
...
/**
 * Search workspaces
 * Search public workspaces by name and language.
 */
export function v3SearchWorkspaces<ThrowOnError extends boolean = false>(options?: Options<V3SearchWorkspacesData, ThrowOnError>) {
