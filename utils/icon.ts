...
export const iconMap = new Map(extensions.supported.filter(d => d.languages).map((d) => {
  return d.languages!.map((l) => {
    ...
    return (ids as string[]).filter(id => recorded.includes(id)).map((id) => {
