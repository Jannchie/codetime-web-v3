...
export const v3GetProducts = <ThrowOnError extends boolean = false>(options: Options<V3GetProductsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<V3GetProductsResponses, V3GetProductsErrors, ThrowOnError>({
 ...
 * Get all active discounts that are not 100% off.
 *
 * Returns:
 * List of active discount objects with amount less than 100% or fixed amounts.
 */
