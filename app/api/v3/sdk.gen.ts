 ...
 */
export const getV3AuthGoogleCallback = <ThrowOnError extends boolean = false>(options: Options<GetV3AuthGoogleCallbackData, ThrowOnError>) => (options.client ?? client).get<unknown, unknown, ThrowOnError>({ url: '/v3/auth/google/callback', ...options });
...
/**
 * Begin Google OAuth (sets state cookie, redirects)
 */
export const getV3AuthGoogleStart = <ThrowOnError extends boolean = false>(options?: Options<GetV3AuthGoogleStartData, ThrowOnError>) => (options?.client ?? client).get<unknown, unknown, ThrowOnError>({ url: '/v3/auth/google/start', ...options });
