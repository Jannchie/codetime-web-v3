...
import type { V3GetRootData, V3GetRootResponses, V3GetTotalMinutesData, V3GetTotalMinutesResponses, V3GithubCallbackData, V3GithubCallbackResponses, V3GithubCallbackErrors, V3GoogleAuthData, V3GoogleAuthResponses, V3GoogleAuthErrors, V3LogoutData, V3LogoutResponses, V3RefreshTokenData, V3RefreshTokenResponses, V3DeleteUserAccountData, V3DeleteUserAccountResponses, V3GetUserSelfData, V3GetUserSelfResponses, V3DeleteUserDataData, V3DeleteUserDataResponses, V3ExportUserDataData, V3ExportUserDataResponses, V3GetPrivacySettingsData, V3GetPrivacySettingsResponses, V3UpdatePrivacySettingsData, V3UpdatePrivacySettingsResponses, V3UpdatePrivacySettingsErrors, V3GetSelfMinutesData, V3GetSelfMinutesResponses, V3GetSelfMinutesErrors, V3GetSelfOverallRankData, V3GetSelfOverallRankResponses, V3GetSelfOverallRankErrors, V3GetSelfTopLanguagesRankData, V3GetSelfTopLanguagesRankResponses, V3GetSelfTopLanguagesRankErrors, V3GetTimeDistributionData, V3GetTimeDistributionResponses, V3GetTimeDistributionErrors, V3GetUserByUserIdData, V3GetUserByUserIdResponses, V3GetUserByUserIdErrors, V3GetUserShieldData, V3GetUserShieldResponses, V3GetUserShieldErrors, V3GetWorkspaceFilesData, V3GetWorkspaceFilesResponses, V3GetWorkspaceFilesErrors, V3ListSelfLatestLogsData, V3ListSelfLatestLogsResponses, V3ListSelfLatestLogsErrors, V3ListSelfStatsData, V3ListSelfStatsResponses, V3ListSelfStatsErrors, V3ListSelfStatsTimeData, V3ListSelfStatsTimeResponses, V3ListSelfStatsTimeErrors, V3ListSelfTopData, V3ListSelfTopResponses, V3ListSelfTopErrors, V3PostEventLogData, V3PostEventLogResponses, V3PostEventLogErrors, V3SearchWorkspacesData, V3SearchWorkspacesResponses, V3SearchWorkspacesErrors, V3GetYearlyReportDataData, V3GetYearlyReportDataResponses, V3GetYearlyReportDataErrors, V3CreateCheckoutData, V3CreateCheckoutResponses, V3CreateCheckoutErrors, V3GetProductsData, V3GetProductsResponses, V3HandleLemonsqueezyWebhookData, V3HandleLemonsqueezyWebhookResponses, V3GetActiveDiscountsData, V3GetActiveDiscountsResponses, V3GetLanguageRankingData, V3GetLanguageRankingResponses, V3GetLanguageRankingErrors, V3GetLeaderboardData, V3GetLeaderboardResponses, V3GetLeaderboardErrors, V3GetUserCodingHistoryData, V3GetUserCodingHistoryResponses, V3GetUserCodingHistoryErrors, V3GetUserLanguageRankData, V3GetUserLanguageRankResponses, V3GetUserLanguageRankErrors, V3GetUserOverallRankData, V3GetUserOverallRankResponses, V3GetUserOverallRankErrors, V3GetUserTopLanguagesRankData, V3GetUserTopLanguagesRankResponses, V3GetUserTopLanguagesRankErrors, V3GetTagsData, V3GetTagsResponses, V3CreateTagData, V3CreateTagResponses, V3CreateTagErrors, V3DeleteTagData, V3DeleteTagResponses, V3DeleteTagErrors, V3GetTagData, V3GetTagResponses, V3GetTagErrors, V3UpdateTagData, V3UpdateTagResponses, V3UpdateTagErrors, V3EvaluateWorkspaceTagsData, V3EvaluateWorkspaceTagsResponses, V3EvaluateWorkspaceTagsErrors, V3GetTagHistoryData, V3GetTagHistoryResponses, V3GetTagHistoryErrors, V3GetTagTimeStatsData, V3GetTagTimeStatsResponses, V3GetTagTimeStatsErrors, V3GetCalendarFeedData, V3GetCalendarFeedResponses, V3GetCalendarFeedErrors, V3GetCalendarInfoData, V3GetCalendarInfoResponses, V3BeAnyUserData, V3BeAnyUserResponses, V3BeAnyUserErrors, V3GetData, V3GetResponses } from './types.gen';
import { client as _heyApiClient } from './client.gen';
import { v3GetTotalMinutesResponseTransformer, v3GetUserSelfResponseTransformer, v3GetSelfOverallRankResponseTransformer, v3GetSelfTopLanguagesRankResponseTransformer, v3GetUserByUserIdResponseTransformer, v3CreateCheckoutResponseTransformer, v3GetActiveDiscountsResponseTransformer, v3GetLanguageRankingResponseTransformer, v3GetLeaderboardResponseTransformer, v3GetUserCodingHistoryResponseTransformer, v3GetUserLanguageRankResponseTransformer, v3GetUserOverallRankResponseTransformer, v3GetUserTopLanguagesRankResponseTransformer, v3GetTagsResponseTransformer, v3CreateTagResponseTransformer, v3GetTagResponseTransformer, v3UpdateTagResponseTransformer, v3EvaluateWorkspaceTagsResponseTransformer, v3GetTagHistoryResponseTransformer, v3GetTagTimeStatsResponseTransformer } from './transformers.gen';
 ...
 */
export const v3GetSelfOverallRank = <ThrowOnError extends boolean = false>(options?: Options<V3GetSelfOverallRankData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<V3GetSelfOverallRankResponses, V3GetSelfOverallRankErrors, ThrowOnError>({
 ...
 */
export const v3GetSelfTopLanguagesRank = <ThrowOnError extends boolean = false>(options?: Options<V3GetSelfTopLanguagesRankData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<V3GetSelfTopLanguagesRankResponses, V3GetSelfTopLanguagesRankErrors, ThrowOnError>({
 ...
 */
export const v3GetActiveDiscounts = <ThrowOnError extends boolean = false>(options?: Options<V3GetActiveDiscountsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<V3GetActiveDiscountsResponses, unknown, ThrowOnError>({
 ...
 */
export const v3GetLanguageRanking = <ThrowOnError extends boolean = false>(options: Options<V3GetLanguageRankingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<V3GetLanguageRankingResponses, V3GetLanguageRankingErrors, ThrowOnError>({
 ...
 */
export const v3GetUserCodingHistory = <ThrowOnError extends boolean = false>(options: Options<V3GetUserCodingHistoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<V3GetUserCodingHistoryResponses, V3GetUserCodingHistoryErrors, ThrowOnError>({
 ...
 */
export const v3GetUserLanguageRank = <ThrowOnError extends boolean = false>(options: Options<V3GetUserLanguageRankData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<V3GetUserLanguageRankResponses, V3GetUserLanguageRankErrors, ThrowOnError>({
 ...
 */
export const v3GetUserOverallRank = <ThrowOnError extends boolean = false>(options: Options<V3GetUserOverallRankData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<V3GetUserOverallRankResponses, V3GetUserOverallRankErrors, ThrowOnError>({
 ...
 */
export const v3GetUserTopLanguagesRank = <ThrowOnError extends boolean = false>(options: Options<V3GetUserTopLanguagesRankData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<V3GetUserTopLanguagesRankResponses, V3GetUserTopLanguagesRankErrors, ThrowOnError>({
 ...
 * Get
 */
export const v3Get = <ThrowOnError extends boolean = false>(options?: Options<V3GetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<V3GetResponses, unknown, ThrowOnError>({
        url: '/v3/metrics',
        ...options
    });
};