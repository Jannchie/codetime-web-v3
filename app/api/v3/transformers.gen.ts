...
import type { V3GetTotalMinutesResponse, V3GetUserSelfResponse, V3GetUserByUserIdResponse, V3CreateCheckoutResponse, V3GetLeaderboardResponse, V3GetTagsResponse, V3CreateTagResponse, V3GetTagRulesResponse, V3CreateTagRuleResponse, V3GetRuleResponse, V3UpdateRuleResponse, V3GetTagResponse, V3UpdateTagResponse, V3EvaluateWorkspaceTagsResponse, V3GetAllTagsHistoryResponse, V3GetTagHistoryResponse, V3GetTagTimeStatsResponse } from './types.gen';
...
const ruleConditionResponseSchemaResponseTransformer = (data: any) => {
    data.createdAt = new Date(data.createdAt);
    data.updatedAt = new Date(data.updatedAt);
    return data;
};

const tagRuleResponseSchemaResponseTransformer = (data: any) => {
    data.conditions = data.conditions.map((item: any) => {
        return ruleConditionResponseSchemaResponseTransformer(item);
    });
    data.createdAt = new Date(data.createdAt);
    data.updatedAt = new Date(data.updatedAt);
    return data;
...
export const v3GetTagRulesResponseTransformer = async (data: any): Promise<V3GetTagRulesResponse> => {
    data = data.map((item: any) => {
        return tagRuleResponseSchemaResponseTransformer(item);
    });
    return data;
};

export const v3CreateTagRuleResponseTransformer = async (data: any): Promise<V3CreateTagRuleResponse> => {
    data = tagRuleResponseSchemaResponseTransformer(data);
    return data;
};

export const v3GetRuleResponseTransformer = async (data: any): Promise<V3GetRuleResponse> => {
    data = tagRuleResponseSchemaResponseTransformer(data);
    return data;
};

export const v3UpdateRuleResponseTransformer = async (data: any): Promise<V3UpdateRuleResponse> => {
    data = tagRuleResponseSchemaResponseTransformer(data);
    return data;
};
...
const workspaceEvaluationResponseSchemaResponseTransformer = (data: any) => {
    data.matchingTags = data.matchingTags.map((item: any) => {
        return tagResponseSchemaResponseTransformer(item);
    });
    return data;
};
...
const tagHistoryItemSchemaResponseTransformer = (data: any) => {
    data.tag = tagResponseSchemaResponseTransformer(data.tag);
    return data;
};

const allTagsHistoryResponseSchemaResponseTransformer = (data: any) => {
    data.tags = data.tags.map((item: any) => {
        return tagHistoryItemSchemaResponseTransformer(item);
    });
...
export const v3GetAllTagsHistoryResponseTransformer = async (data: any): Promise<V3GetAllTagsHistoryResponse> => {
    data = allTagsHistoryResponseSchemaResponseTransformer(data);
    return data;
};
