...
export const AllTagsHistoryResponseSchema = {
    properties: {
        tags: {
            items: {
    ...
    type: 'object',
    required: ['periodEnd', 'periodStart', 'tags', 'totalMinutes'],
    title: 'AllTagsHistoryResponse'
} as const;
...
export const TagHistoryItemSchema = {
    properties: {
        tag: {
    ...
    type: 'object',
    required: ['tag', 'timeBreakdown', 'totalMinutes'],
