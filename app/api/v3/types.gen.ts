...
/**
 * AllTagsHistoryResponse
 */
export type AllTagsHistoryResponse = {
    tags: Array<TagHistoryItem>;
    totalMinutes: number;
    periodStart: Date;
    periodEnd: Date;
};
...
export type TagHistoryItem = {
    tag: TagResponse;
    totalMinutes: number;
    timeBreakdown: Array<StatsTimeData>;
};
...
export type V3GetAllTagsHistoryData = {
    body?: never;
    path?: never;
    query?: {
        /**
...
export type V3GetAllTagsHistoryErrors = {
    /**
     * Validation Exception
     */
    400: {
...
export type V3GetAllTagsHistoryError = V3GetAllTagsHistoryErrors[keyof V3GetAllTagsHistoryErrors];

export type V3GetAllTagsHistoryResponses = {
    /**
     * Request fulfilled, document follows
     */
    200: AllTagsHistoryResponse;
};

export type V3GetAllTagsHistoryResponse = V3GetAllTagsHistoryResponses[keyof V3GetAllTagsHistoryResponses];
